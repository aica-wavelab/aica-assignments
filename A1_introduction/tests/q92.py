...
def test_min_price(env):
    ...
    assert type(env['price_min']) == np.int32 or type(env['price_min']) == np.int64, 'The variable price_min has the wrong data type'
...
def test_max_price(env):
    ...
    assert type(env['price_max']) == np.int32 or type(env['price_max']) == np.int64, 'The variable price_max has the wrong data type'
